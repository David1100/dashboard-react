    ...
    >
      ...
      <div className="relative pt-16 lg:pt-8 text-gray-300 p-8 h-full">
        ...
        <div>
          ...
          {/* Products */}
          <div className="h-[180px] md:h-[700px] lg:h-[230px] 2xl:h-[530px] overflow-y-scroll scroll">
            {/* Product */}
            <div className="bg-[#262837] p-4 rounded-xl mb-4">
              <div className="grid grid-cols-6 mb-4">
                {/* Product description */}
                <div className="col-span-4 flex items-center gap-3">
                  <img src="https://www.frutosdelmargroup.com/wp-content/uploads/2023/06/Sin-titulo-3-1.png" className="w-10 h-10 object-cover" />
                  <div>
